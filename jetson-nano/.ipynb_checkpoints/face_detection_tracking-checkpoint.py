...
1. If a basic code works on nano.
2. The frame rates of face detection based on haar cascades.
"""
...
w, h = 360, 240            # set the resolution to work with
fbRange = [6200, 6800]     # The desired area range of bounding box for keeping the robot distance
pid = [0.4, 0.4, 0]
pError = 0
...
if __name__ == '__main__':
    ...
    while True:
        ...
        cv2.putText(img, f'yaw: {speed}, movement: {fb}, FPS:{fps}', 
